...
public class ReadJSONWebCatalogoBrasil {
	public static void main(String[] args) throws IOException, ParseException {
		 ...
		 * FileReader readerdoencas = new FileReader("src/doencas.json"); FileReader
		 * readerPhytophtora = new FileReader("src/phytopstora.json"); FileReader
		 * readerNematoides = new FileReader("src/nematoides.json"); FileReader
		 * readerGalha = new FileReader("src/galhia.json"); FileReader
		 * readerpontos_fortes = new FileReader("src/pontosf.json");
		 */
		...
		/*
		 * Object agronom = jsonparser3.parse(readerAgronomicas, (ContainerFactory)
		 * containerFactory); Object pdoencas = jsonparser4.parse(readerdoencas,
		 * (ContainerFactory) containerFactory);
		 * 
		 * Object phytophtora = jsonparser5.parse(readerPhytophtora, (ContainerFactory)
		 * containerFactory); Object nematoides = jsonparser6.parse(readerNematoides,
		 * (ContainerFactory) containerFactory); Object galha =
		 * jsonparser7.parse(readerGalha, (ContainerFactory) containerFactory); Object
		 * fortes = jsonparser8.parse(readerpontos_fortes, (ContainerFactory)
		 * containerFactory);
		 */
		...
		/*
		 * JSONArray arrayAgronomica = (JSONArray) agronom; JSONArray arrayDoencas =
		 * (JSONArray) pdoencas; JSONArray arrayPhytophtora = (JSONArray) phytophtora;
		 * JSONArray arrayNematoides = (JSONArray) nematoides; JSONArray arrayGalha =
		 * (JSONArray) galha;
		 * 
		...
		for (int i = 0; i < arrayProd.size() ; i++) {
			 ...
			 * LinkedHashMap pontosF = (LinkedHashMap) arrayPFortes.get(i); LinkedHashMap
			 * cDoencas = (LinkedHashMap) arrayDoencas.get(i);
			 * 
